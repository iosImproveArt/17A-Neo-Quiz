...
struct Question {
    ...
    static let advancedQuestions: [Question] = [
        Question(
            ...
            correctAnswer: "Hg",
            answerOptions: ["Au", "Hg", "Ag", "Sn"]
        ),
        Question(
            question: "Which organelle is known as the powerhouse of the cell?",
            correctAnswer: "Mitochondria",
            answerOptions: ["Nucleus", "Mitochondria", "Ribosomes", "Golgi Apparatus"]
        ),
        Question(
            question: "Who proposed the theory of evolution by natural selection?",
            correctAnswer: "Charles Darwin",
            answerOptions: ["Gregor Mendel", "Charles Darwin", "Jean-Baptiste Lamarck", "Alfred Wallace"]
        ),
        Question(
        ...
        Question(
            ...
            answerOptions: ["Propane", "Ethane", "Methane", "Butane"]
        ),
        Question(
            question: "What is the unit of electrical resistance?",
            correctAnswer: "Ohm",
            answerOptions: ["Volt", "Watt", "Ohm", "Ampere"]
        ),
        Question(
            question: "Which element has the highest atomic number?",
            correctAnswer: "Oganesson",
            answerOptions: ["Uranium", "Plutonium", "Oganesson", "Radon"]
        ),
        Question(
            question: "Which continent is the largest by land area?",
            correctAnswer: "Asia",
            answerOptions: ["Africa", "Asia", "North America", "Antarctica"]
        ),
        Question(
        ...
        Question(
            ...
            answerOptions: ["Meiosis", "Mitosis", "Cytokinesis", "Binary Fission"]
        ),
        Question(
